...
<div class="col-md-offset-1 col-md-10 col-sm-12">
    ...
    if ($j == 1): ?>
    <div class="tpl-eqp__list bck-list col-sm-12 col-md-4">
        <?php endif; ?>
        <article class="list-item list-item__tpl-eqp col-md-12 col-sm-6">
            <?php if ($img) : ?>
                <div class="round">
    ...
    <div class="tpl-eqp__list bck-list list <?php echo ($j % 3 == 0 && !($j % 2 == 0)) ? ' decale' : (($j % 6 == 0) ? 'decale-small' : '') ?> col-sm-12 col-md-4">
        <?php endif;
        $j++;
        endwhile;
        endif;
